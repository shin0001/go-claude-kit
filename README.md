...
**Caveman**  
[Caveman comprime o *estilo* das respostas (~65% menos tokens de saída) mantendo código/comandos byte-exatos — e responde no seu idioma (português entra, caveman-português sai).](https://github.com/JuliusBrussee/caveman "https://github.com/JuliusBrussee/caveman")  
